...
export default function Hero() {
  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center relative overflow-hidden bg-gradient-to-br from-blue-900 to-purple-900 w-full">
      {/* Background Overlay */}
      <div className="absolute inset-0 bg-black/30 z-0"></div>

      {/* Content Container */}
      <div className="z-10 w-full max-w-4xl mx-auto px-2 sm:px-4 flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 overflow-x-hidden">
        ...
        >
          <div className="bg-white/10 backdrop-blur-md p-3 sm:p-6 rounded-2xl shadow-2xl border border-white/20 relative w-full max-w-[320px]">
            <motion.div
        ...
        >
          <h1 className="text-2xl xs:text-3xl sm:text-4xl md:text-6xl font-bold mb-3 md:mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-600 break-words">
            Lavanya Cheshani
          </h1>
          <p className="text-sm xs:text-base sm:text-lg md:text-2xl mb-3 md:mb-8 text-gray-300">
            AI Enthusiast | Software Engineer | Innovator
          </p>

          {/* Tagline Animation */}
          <div className="h-14 md:h-20 mb-5 md:mb-8">
            <TypeAnimation
              sequence={taglines.flatMap((tagline) => [tagline, 2000])}
              wrapper="p"
              speed={50}
              repeat={Infinity}
              className="text-base xs:text-lg md:text-2xl text-blue-300"
            />
          </div>
